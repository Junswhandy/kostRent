...
<div class="h-full p-3 space-y-2 w-60 dark:bg-gray-50 dark:text-gray-800 bg-slate-800 text-white">
  ...
  <div class="divide-y dark:divide-gray-300">
      <ul class="pt-2 pb-4 space-y-1 text-sm">
          <li class="dark:bg-gray-100 dark:text-gray-900">
              <a rel="noopener noreferrer" href="{{route('owner.dashboard')}}" class="flex items-center p-2 space-x-3 rounded-md">
          ...
          <li>
              <a rel="noopener noreferrer" href="{{route('owner.user')}}" class="flex items-center p-2 space-x-3 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-600">
          ...
          <li>
              <a rel="noopener noreferrer" href="{{route('kost.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-600">
